class Rectangle:
    ...
    def get_amount_inside(self, shape):
        # Calculate how many times the shape can fit horizontally and vertically
...
class Square(Rectangle):
    ...
    def set_width(self, width):
        # For squares, setting width should also set height
        self.width = width
        self.height = width
    
    def set_height(self, height):
        # For squares, setting height should also set width
        self.width = height
        self.height = height
